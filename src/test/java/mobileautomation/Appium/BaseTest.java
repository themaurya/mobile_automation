...
public class BaseTest {
	...
	public void configureAppium() throws MalformedURLException {
		service = new AppiumServiceBuilder()
				.withAppiumJS(
						new File("C:\\Users\\maury\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
	...
	public void logPressAction(WebElement wele) {
		((JavascriptExecutor) driver).executeScript("mobile: longClickGesture",
				ImmutableMap.of("elementId", ((RemoteWebElement) wele).getId(), "duration", 2000));
	}
	...
	public void scrollToEndAction() {
		...
		do {
			canScrollMore = (Boolean) ((JavascriptExecutor) driver).executeScript("mobile: scrollGesture", ImmutableMap
					.of("left", 100, "top", 100, "width", 200, "height", 200, "direction", "down", "percent", 1));
		} while (canScrollMore);
	}
